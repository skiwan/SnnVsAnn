...
class SimpleIZModel(object):
	def __init__(self,*, input_layer_neurons, output_layer_neurons, input_layer_weight_matrix, intermediate_weight_matrix, amplifier ,current_value):
	...
	def single_forward(self, input_sample, timestep=1):
		...
		input_current = [weighted_input[n].sum()*self.amplifier for n in range(self.input_neuron_count)]
