            ...
            for weight_decay in weight_decays:
                for dropout in dropouts:
                    for cut_off in cut_offs:
                        ...
                        experiment_name = f'Binary_ANN_A{n}_learnrate{learning_rate}_weightdec{weight_decays}_cutoff{cut_off_front}_{cut_off_back}_drop{dropout}'
                        ...
                        if best_acc < overall_best_accuracy or last_acc < overall_best_accuracy:
                            overall_best_accuracy = min(best_acc, last_acc)
                            params = {'learning_rate': learning_rate
                            , 'weight_decay': weight_decay
                            , 'cut_off_front': cut_off_front
                            , 'cut_off_back': cut_off_back
                            , 'dropout': dropout
                            , 'best_accuracy_multi': min(best_acc, last_acc)}
