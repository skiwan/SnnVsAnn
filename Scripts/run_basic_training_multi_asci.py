...
def main(experiment_name, experiment_description, subject_name= 'k3b', subject_nr='1'):
    ...
    generate_train_and_eval_data(f'{base_save_path}raw_{low_pass}_{high_pass}.npy', train_idx, eval_idx, base_save_path,
                                 low_pass, high_pass)
