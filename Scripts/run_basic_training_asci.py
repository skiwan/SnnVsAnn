...
def run_threaded_model(config):
    ...
    experiment_name = f'{experiment_name}_learnrate{learning_rate}_weightdec{weight_decay}_cutoff{data_cut_front}_{data_cut_back}_drop{dropout}'  # 'Binary_ANN_A01'
    save_model = True
...
def main(experiment_name, experiment_description, learning_rates, weight_decays, cut_offs, dropouts,
